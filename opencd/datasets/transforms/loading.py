...
@TRANSFORMS.register_module()
class MultiImgLoadImageTIF(MMCV_LoadImageFromFile):
    """Load an image pair from TIF files using rasterio.
...
@TRANSFORMS.register_module()
class MultiImgLoadAnnotationsGray(MMCV_LoadAnnotations):
    """Load annotations for change detection provided by dataset.
